...
def inicializaObjetos():
    ...
    points = [
        ...
        #QUADRADO
        0.1, 0.1, 0.0, #esquerda cima
        0.25, 0.1, 0.0, #direita cima
        0.25, -0.1, 0.0, #direita baixo
        0.1, -0.1, 0.0, #/esquerda baixo
...
def inicializaShaders():
    ...
    fragment_shader = """
		...
		void main () {
		    frag_colour = vec4 (abs((cores-1.0)) , 1.0);
		}
    """
