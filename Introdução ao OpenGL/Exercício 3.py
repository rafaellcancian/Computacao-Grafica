#Ex1 - Renderização de um triângulo.py
...
def inicializaObjetos():
    ...
    #verificar qual o vertice de cima
    ponto1 = [points[0] , points[1], points[2]]
    ponto2 = [points[3] , points[4], points[5]]
    ponto3 = [points[6] , points[7], points[8]]

    posicaoCorPonto1 = verificarVerticePosicaoCor(ponto1, ponto2, ponto3)
    posicaoCorPonto2 = verificarVerticePosicaoCor(ponto2, ponto1, ponto3)
    posicaoCorPonto3 = verificarVerticePosicaoCor(ponto3, ponto1, ponto3)

    print(posicaoCorPonto2)
    ...
    cores[posicaoCorPonto1] = 1.0
    cores[posicaoCorPonto2+3] = 1.0
    cores[posicaoCorPonto3+6] = 1.0
...
def verificarVerticePosicaoCor(points1 ,points2 ,points3):
    if (points1[1] > points2[1]) and (points1[1] > points3[1]):
        return 0
    elif (points1[0] > points2[0]) and (points1[0] > points3[0]):
        return 1
    else:
        return 2
